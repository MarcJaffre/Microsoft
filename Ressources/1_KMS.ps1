...
# Fonctionnement :
#  - Activation de Microsoft Windows 10, 11, 2016, 2019, 2022
#
########################################################################################################################################################################################################

########################################################################################################################################################################################################
# Lancer le conteneur : docker run -d  --name KMS --network bridge --restart unless-stopped -p 1688:1688 mikolatero/vlmcsd
# Indiquer l'adresse IP de la machine hébergent docker ($SRV)
# Lancer le script (Windows server nécessite un reboot et une relance du script)
########################################################################################################################################################################################################
